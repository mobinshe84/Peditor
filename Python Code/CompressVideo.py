...
class Ui_CompressVideo(QWidget):
    ...
    def GetVideo(self):
        ...
        if dialog.exec_() == QtWidgets.QDialog.Accepted:
            ...
            self.UpdateStatusVideo()
            
        else:
            return None
    
    def UpdateStatusVideo(self):
        try:
            _ = Address
        except:
            return
    ...
    def CompressClicked(self):
        ...
        CompressThread = threading.Thread(target = CompressingVideo.CompressingVideo.Compress, args = [CompressingVideo.CompressingVideo, Address])
    ...
    def SavePic(self):
        ...
        if SaveVideoDialog.exec_() == QDialog.Accepted:
            SavedAddress = str(SaveVideoDialog.selectedFiles()[0])
