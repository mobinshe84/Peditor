...
class Ui_CompressingVideo(QWidget):
    def setupUi(self, Peditor):
        ...
        self.CompressingLabel.setFont(Variables.LFont)
        ...
        self.ProgressBar.setFont(Variables.LFont)
...
class CompressingVideo():
    # ---------------------------------------------------------------------------------------------------------- #
    def Compress(self, Address, SaveAddress):
        folder, img_name = 'frames', 'frame'
        audio, video, resolution = self.load_video(self, Address)
        FPS, seconds = self.get_FPS(self, video)
        self.save_frames(self, seconds, FPS, video, resolution, folder, img_name, SaveAddress, audio)
